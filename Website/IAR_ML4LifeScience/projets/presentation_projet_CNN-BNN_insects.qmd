---
title: "Apport d'un modèle Bayésien lors de l'utilisation de réseaux de neuronnes pour la classification d'images"
subtitle: "14h10–14h30"
description: "Comparaison de 2 'versions' du modèle AlexNet pour la classification d'images, exemple sur un jeu d'images d'insectes"
author:
  - name: "Roattino Thibault"
...
date: 2025-11-21 
image: ../img_projets/image_insecte.jpg
listing:
  id: projets
---
...
- [Github](https://github.com/BelloW34/BNN_insect)

## Lien vers les slides

- [Slides](https://github.com/DataScience-ACO-2025/ML4LifeSciences_ACO_2025/tree/main/submissions/BNN_insect/.presentation)
