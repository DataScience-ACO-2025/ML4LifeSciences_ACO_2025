...
from layers import ModuleWrapper#, FlattenLayer


import torch
from layers.misc import ModuleWrapper  # si tu en as besoin
...
class FlattenLayer(ModuleWrapper):
    ...
    def forward(self, x):
        batch_size = x.size(0)        # taille du batch
...
class BBBAlexNet(ModuleWrapper):
    ...
    def __init__(self, outputs, inputs, priors, layer_type='lrt', activation_type='softplus'):
        ...
        self.classifier = BBBLinear(256 * 6 * 6, outputs, bias=True, priors=self.priors)
